export function getConfig(env = process.env) {
  return {
    ...
    openaiMaxPages: numberEnv(env.OPENAI_MAX_PAGES, 8),
    openaiMaxChars: numberEnv(env.OPENAI_MAX_CHARS, 30000),
    openaiMaxOutputTokens: numberEnv(env.OPENAI_MAX_OUTPUT_TOKENS, 10000),
    manualSearchTranslate: env.MANUAL_SEARCH_TRANSLATE === '1',
    manualSearchBudgetMs: numberEnv(env.MANUAL_SEARCH_BUDGET_MS, 26000),
    translatedPageRepairTimeoutMs: numberEnv(env.TRANSLATED_PAGE_REPAIR_TIMEOUT_MS, 6000),
    translatedPageRepairMinRemainingMs: numberEnv(env.TRANSLATED_PAGE_REPAIR_MIN_REMAINING_MS, 8000),
    translatedPageRepairMaxPages: numberEnv(env.TRANSLATED_PAGE_REPAIR_MAX_PAGES, 4),
    translatedPageRepairMaxBlocks: numberEnv(env.TRANSLATED_PAGE_REPAIR_MAX_BLOCKS, 80),
